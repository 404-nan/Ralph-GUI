...
- 基本方針は「現在のTaskを1つ終わらせること」を優先し、全部を一度に終わらせようとしないでください
- 現在のTaskが完了したら `[[TASK]] <id> | completed | <title>` を出し、その run は `[[DONE]]` で閉じてください
- 次のTaskが残っている場合でも、次回 run で取り組めるように整理して止めてください
